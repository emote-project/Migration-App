...
public class FacesBufferedList
{
	...
	public FacesBufferedList(FacesBufferedList f) {
		this._b = f._b;
		this._numElements = f._numElements;
		this._renderSubsetStartIndex = f._renderSubsetStartIndex;
		this._renderSubsetLength = f._renderSubsetLength;
		this._renderSubsetEnabled = f._renderSubsetEnabled;
	}
