...
public class Object3d
{
	...
	private boolean _hasMaterial = false;

	private GlMaterial _material = new GlMaterial();
	...
	//TODO location hack
	private Number3d _localO = new Number3d(0,0,0);
	...
	//IAIN added copy constructor
	public Object3d(Object3d o)
	{
		this._name = o.name();
		this._renderType = o.renderType();
		this._isVisible = o.isVisible();
		this._vertexColorsEnabled = o.vertexColorsEnabled();
		this._doubleSidedEnabled = o.doubleSidedEnabled();
		this._texturesEnabled = o.texturesEnabled();
		this._normalsEnabled = o.normalsEnabled();
		this._ignoreFaces = o.ignoreFaces();
		this._colorMaterialEnabled = o.colorMaterialEnabled();
		this._lightingEnabled = o.lightingEnabled();
		this._position = o.position();
		this._rotation = o.rotation();
		this._scale = o.scale();
		this._defaultColor = o.defaultColor();
		this._shadeModel = o.shadeModel();
		this._pointSize = o.pointSize();
		this._pointSmoothing = o.pointSmoothing();
		this._lineWidth = o.lineWidth();
		this._lineSmoothing = o.lineSmoothing();
		this._children = o._children;
		
		//this._vertices = o.vertices();
		this._vertices = new Vertices(o.vertices());
		...
		try {
			if (o.textures() != null ) {
				for (int i = 0; i < o.textures().size(); i++) {
					TextureVo t = o.textures().get(i); 
					this._textures.add(new TextureVo(t));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		//this._faces = o.faces();
		this._faces = new FacesBufferedList(o._faces);
		
		this._animationEnabled = o.animationEnabled();
		this._scene = o.scene();
		this._parent = o.parent();
		this._localO = o.getLocalO();
		this._hasMaterial = o.hasMaterial();
		this._material = o.getMaterial();
	}
	/**
	...
	public void setLocalO(Number3d _localO) {
		this._localO = _localO;
	}
	public Number3d getLocalO() {
		return _localO;
	}
	public boolean hasMaterial() {
		return _hasMaterial;
	}
	public void setMaterial(GlMaterial _material) {
