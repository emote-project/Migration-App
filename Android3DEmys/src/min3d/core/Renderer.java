...
public class Renderer implements GLSurfaceView.Renderer
{
	...
	protected void drawScene()
	{
		...
		{
			// iain changed this 
			Object3dContainer o = _scene.children().get(i);
	...
	protected void drawObject(Object3dContainer $o)
	{
...
// IAIN material hack
// ideally i'd preserve state and push/pop but not possible. This relys on a sensible
		//default colour
		//if ($o.hasMaterial()) {
			_gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_AMBIENT, $o.getMaterial().getAmb());
			_gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_DIFFUSE, $o.getMaterial().getDiff());
			_gl.glMaterialfv(GL10.GL_FRONT_AND_BACK, GL10.GL_SPECULAR, $o.getMaterial().getSpec());
			_gl.glMaterialf(GL10.GL_FRONT_AND_BACK, GL10.GL_SHININESS, $o.getMaterial().getShiny());
		//}
		...
		//IAIN added
		//Log.v("3D DEBUG","DRAWING:"+$o.name()+" at: " +$o.position());
		...
		//
		// Recurse on children
		//  IAIN updated to recurse properly, 

			
			for (int i = 0; i < $o.children().size(); i++)
			{
				//always will be a container now..
				Object3dContainer o = $o.children().get(i);
				drawObject(o);
			}
