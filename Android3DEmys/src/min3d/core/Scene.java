...
{
	private ArrayList<Object3dContainer> _children = new ArrayList<Object3dContainer>();
	...
	/*
	 * IAIN added a nasty hack to allow disabling reset, so when the app hits pause/resume
	 * the scene isn't reset. MAY CAUSE ISSUES
	 */
	private boolean doReset = true;
	public boolean resetEnabled() { return doReset;}
	public void disableReset() { doReset = false;}
	public void enableReset() { doReset = true;}
	...
	public void reset()
	{
		...
		_children = new ArrayList<Object3dContainer>();
	 ...
	 * Returns always true. 
	 */
	public void addChild(Object3dContainer $o)
	{
	...
	public void addChildAt(Object3dContainer $o, int $index)
	{
		if (_children.contains($o)) return;
	 ...
	 */
	public boolean removeChild(Object3dContainer $o)
	{
		$o.parent(null);
		$o.scene(null);
	...
	{
		Object3dContainer o = _children.remove($index);
	 ...
	 */
	public Object3dContainer getChildByName(String $name)
	{
	...
	*/
	 ...
	 * Used by Renderer 
	 */
	ArrayList<Object3dContainer> children() /*package-private*/ 
	{
		return _children;
	}
	...
	public void removeChild(Object3d object3d) {
		removeChild(getChildByName(object3d.name()));
