...
public class ParseObjectData {
	...
	public ParseObjectData()
	{
		...
		this.localO = new Number3d(0, 0, 0);
	}
	...
	{
		// IAIN hack to update using local O goes here
		for (int i =0; i< vertices.size(); ++i) {
			((Number3d)vertices.toArray()[i]).subtract(localO);
		}
		//obj.position().setAllFrom(localO);
		obj.setLocalO(localO.clone());
		// end hack
