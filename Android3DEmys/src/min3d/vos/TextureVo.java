...
public class TextureVo 
{
	...
	//IAIN added this to copy
	public TextureVo( TextureVo t) {
		this.textureId = t.textureId;
		this.repeatU = t.repeatU;
		this.repeatV = t.repeatV;
		this.offsetU = t.offsetU;
		this.offsetV = t.offsetV;

		this.textureEnvs = new ArrayList<TexEnvxVo>();
		for (TexEnvxVo tev: t.textureEnvs) {
			this.textureEnvs.add(new TexEnvxVo(tev.pname, tev.param));
		}
